...
import (
	...
	proof "github.com/filecoin-project/specs-actors/v4/actors/runtime/proof"
...
func (t *ExpTipSet) MarshalCBOR(w io.Writer) error {
	...
	// t.Blocks ([]*lotus.BlockHeader) (slice)
...
func (t *BlockHeader) MarshalCBOR(w io.Writer) error {
	...
	// t.Ticket (lotus.Ticket) (struct)
	if err := t.Ticket.MarshalCBOR(w); err != nil {
		return err
	}

	// t.ElectionProof (lotus.ElectionProof) (struct)
	if err := t.ElectionProof.MarshalCBOR(w); err != nil {
		return err
	}

	// t.BeaconEntries ([]lotus.BeaconEntry) (slice)
...
func (t *SignedMessage) MarshalCBOR(w io.Writer) error {
	...
	// t.Message (lotus.Message) (struct)
