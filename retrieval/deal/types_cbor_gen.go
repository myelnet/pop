...
func (t *Payment) UnmarshalCBOR(r io.Reader) error {
	*t = Payment{}
	...
	if extra > cbg.MaxLength {
		return fmt.Errorf("Payment: map struct too large (%d)", extra)
	}
...
func (t *ClientState) MarshalCBOR(w io.Writer) error {
	...
	// t.Proposal (deal.Proposal) (struct)
	...
	// t.PaymentInfo (deal.PaymentInfo) (struct)
...
func (t *ClientState) UnmarshalCBOR(r io.Reader) error {
	*t = ClientState{}
	...
	if extra > cbg.MaxLength {
		return fmt.Errorf("ClientState: map struct too large (%d)", extra)
	}
...
func (t *ProviderState) UnmarshalCBOR(r io.Reader) error {
	*t = ProviderState{}
	...
	if extra > cbg.MaxLength {
		return fmt.Errorf("ProviderState: map struct too large (%d)", extra)
	}
		...
		case "PayCh":

			{
				...
				if b != cbg.CborNull[0] {
					...
					t.PayCh = new(address.Address)
					if err := t.PayCh.UnmarshalCBOR(br); err != nil {
						return xerrors.Errorf("unmarshaling t.PayCh pointer: %w", err)
					}
				}
